...
class FirewallSwitch(app_manager.RyuApp):
    """
    Advanced switch with firewall capabilities
    Blocks ICMP traffic from h1 (10.0.1.1) to h3 (10.0.2.1)
    """
    ...
    def switch_features_handler(self, ev):
        ...
        # Install FIREWALL RULE: Block ICMP from h1 to h3
        # Priority 100 (high priority - checked first)
        match = parser.OFPMatch(
            eth_type=0x0800,           # IPv4
            ipv4_src='10.0.1.1',       # Source: h1
            ipv4_dst='10.0.1.3',       # Destination: h3
            ip_proto=1                 # ICMP protocol
        )
        # NO actions = DROP (discard the packet)
        self.add_flow(datapath, 100, match, [])

        self.logger.info("Firewall enabled - blocking ICMP h1->h3")
